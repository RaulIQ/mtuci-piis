...
st.caption(
    "**Нагрузка на сеть (оценка на клиенте):** в блоке ниже считаются байты полезной нагрузки WebSocket "
    "(JSON конфиг, затем непрерывный поток PCM float32 и входящие JSON). "
    "Накладные расходы TCP/WebSocket не учитываются. Сравните с страницей «Realtime KWS · log-mel» (NPZ реже и меньше по объёму)."
)
